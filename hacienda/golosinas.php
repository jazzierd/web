...
<body>
    <div class="container">
        ...
        <main>
            ...
            <h1>Productos de Golosinas</h1><br>

            <section class="pepes">
<?php
$conn = conectarse();

$sql = "SELECT * FROM productos WHERE categoria_producto = 'Golosinas'";
...
<?php
    ...
    echo "<p>No se encontraron productos en la categoría de Golosinas.</p>";
}
