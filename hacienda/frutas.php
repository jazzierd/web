...
<body>
    <div class="container">
        ...
        <main>
            ...
            <h1>Productos de Frutas y Verduras</h1><br>

            <section class="pepes">
<?php
$conn = conectarse();

$sql = "SELECT * FROM productos WHERE categoria_producto = 'Frutas'";
...
<?php
    ...
    echo "<p>No se encontraron productos en la categoría de Frutas y Verduras.</p>";
}
